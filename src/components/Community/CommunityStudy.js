...
const CommunityStudy = () => {
  ...
  const [currentPage, setCurrentPage] = useState(() => {
    return parseInt(localStorage.getItem('studyCurrentPage')) || 0;
  });
  ...
  const handlePageChange = async (pageNumber) => {
    localStorage.setItem('studyCurrentPage', pageNumber);
  ...
  return (
    <div className='container'>
      ...
      <div>
        <p className='community-title'>스터디 게시판</p>
        ...
        <div className='community-select'>
          ...
          <span className='community-select-line'>
            <Link to="/study/post-form" className='write-button'>
              ✎ 글쓰기
            </Link>
          </span>
        </div>
